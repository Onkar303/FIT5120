...
namespace FIT5120_Project_Refugees.Controllers
{
    public class TermsController : Controller
    {
        ...
        public ActionResult Create([Bind(Include = "TERM_ID,TERM_NAME,TERM_DESC")] Term term)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public ActionResult Edit([Bind(Include = "TERM_ID,TERM_NAME,TERM_DESC")] Term term)
        {
            if (ModelState.IsValid)
            {
