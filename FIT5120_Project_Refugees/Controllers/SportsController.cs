...
namespace FIT5120_Project_Refugees.Controllers
{
    public class SportsController : Controller
    {
        ...
        public ActionResult Create([Bind(Include = "SPORT_ID,SPORT_NAME,SPORT_DESC,SPORT_BENIFIT")] Sport sport)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public ActionResult Edit([Bind(Include = "SPORT_ID,SPORT_NAME,SPORT_DESC,SPORT_BENIFIT")] Sport sport)
        {
            if (ModelState.IsValid)
            {
